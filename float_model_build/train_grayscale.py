...
from datasets import Syn_NTIRE, test_data_NTIRE, PairedDenoisingDataset, Syn_NTIRE_improved
...
def checkpoint_test_multi(test_loader, best, epoch, best_epoch, text_path,
...
if __name__ == '__main__':
    ...
    dataset = Syn_NTIRE_improved('/home/bledc/Pictures/grayscale', 3800, patch_size=256)  # Use grayscale dataset
    test_dataset = ConcatDataset([
        PairedDenoisingDataset("/home/bledc/Pictures/CBSD68-dataset/CBSD68/grayscale_noise15", noise_level=15),
    ...
    for i in range(0, num_epochs + 1):
        ...
        if i % 10 == 0:
            ...
            best, best_epoch = checkpoint_test_multi(test_loader, best, i, best_epoch, text_path, denoiser_model,
