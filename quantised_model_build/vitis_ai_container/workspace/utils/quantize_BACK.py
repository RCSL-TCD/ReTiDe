...
from utils.dataloader import get_grayscale_loaders, DenoiseDatasetGrayScale, get_multi_noise_loaders
...
def quantize_qat_gray(float_model, data_path, batch_size=16, qat_epochs=10):
    ...
    #train_loader, val_loader, test_loader = get_multi_noise_loaders(data_path, batch_size=batch_size, val_ratio=0.1, test_ratio=0.2)
    ...
    optimizer = optim.Adam(quantized_model.parameters(), lr=1e-8)
    ...
    #train_loader, val_loader, test_loader = get_multi_noise_loaders(data_path, batch_size=1, val_ratio=0.2, test_ratio=0.2)
